...
const infos_router = require('./routes/api/infos_router')
const log_router = require('./routes/api/log_router')
const article_router = require('./routes/api/article_router')
const comment_router = require('./routes/api/comment_router')
const response_router = require('./routes/api/response_router')
...
app.use(infos_router.routes())
app.use(log_router.routes())
app.use(article_router.routes())
app.use(comment_router.routes())
app.use(response_router.routes())
